...
<body>
 ...
 <section class="hero-wrap hero-wrap-2" style="background-image: url('../includes/images/21.jpg');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <h1 class="mb-0 bread">Details de la Publication : <?= $blogs->nom; ?></h1>
     </div>
   </div>
 </div>
</section>
   ...
   <div class="col-md-4 ftco-animate d-flex align-items-center align-items-stretch">
    <div class="staff-2 w-100">
     <div class="img-wrap d-flex align-items-stretch">
      <a href="zoom.php?id=">
      <div class="img align-self-stretch d-flex align-items-end" style="background-image: url('../includes/images/21.jpg');">
