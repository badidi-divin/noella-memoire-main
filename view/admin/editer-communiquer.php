<?php
	...
	require_once '../../model/admin/edit-communiquer.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="contenair space col-md-6 col-xd-12 col-md-offset-3">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="a">EDITER COMMUNIQUE</h3>
		</div>
		<div class="panel-body">
			<form method="post" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" name="evenement" required="required" class="form-control" value="<?= $userinfo['id_evenement']?>">
				</div>
				<div class="form-group">
					<label class="control-label">
						Description:
				...
				<div class="form-group a">
					<button type="submit" class="btn btn-primary" name="formconnect">Mettre à Jour</button>
				</div>
			</form>
			<?php
			if (isset($erreur)) {
